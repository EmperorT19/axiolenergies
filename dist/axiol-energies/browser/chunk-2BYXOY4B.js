...
// src/app/core/services/axiol-data.service.ts
var AxiolDataService = class _AxiolDataService {
  constructor() {
    ...
    this.fuelArchitecture = [
      { stepNumber: 1, stage: "STORE", description: "Sized and compliant tanks", icon: "fa-database" },
      { stepNumber: 2, stage: "TRANSFER", description: "Pumps and piping lines", icon: "fa-pipe" },
  ...
  static {
    this.\u0275fac = function AxiolDataService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _AxiolDataService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _AxiolDataService, factory: _AxiolDataService.\u0275fac, providedIn: "root" });
  }
};
...
//# sourceMappingURL=chunk-2BYXOY4B.js.map
